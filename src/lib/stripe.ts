...
export const PLAN_DETAILS = {
  free: {
    ...
    features: [
      ...
      "🤖 Agentic IDE (Shadow Cowork)",
      "🌐 Shadow Browser & Web Scraping",
      "👁️ Visual Reasoning & Image Decoder",
      "📄 Canvas & document editing",
      "🧠 AI Memory across sessions",
      "💻 Code generation & execution",
      "3 S.E.E. missions/month",
      "Basic cloud models (Gemini Flash)",
    ],
  ...
  pro: {
    ...
    features: [
      ...
      "🖼️ 20 cloud image generations/day",
      ...
      "🛡️ Security & Code Quality Auditor",
      "No advertisements",
  ...
  elite: {
    ...
    features: [
      ...
      "♾️ Unlimited cloud image generations",
      "♾️ Unlimited Deep Research",
      "✈️ Zero-download Offline Models (Llama-3 pre-installed)",
      "🔒 Stealth Vault (E2E encrypted)",
      "🤖 Unlimited Agentic Workflows",
